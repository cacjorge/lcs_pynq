...
entity lcs_zigzag_pynq_50k_Ctrl_s_axi is
generic (
...
end entity lcs_zigzag_pynq_50k_Ctrl_s_axi;
...
-- 0x34 : Control signal of res
--        bit 0  - res_ap_vld (Read/COR)
--        others - reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of lcs_zigzag_pynq_50k_Ctrl_s_axi is
